...
= 1.0.9 =
* Added Ability to Send SMS to Admin Phone Number

= 1.0.8 =
* Rectified SMS not sending in latest WP and WC.

= 1.0.7 =
* Added Two factor OTP mobile phone Authentication.
* Added Added SMS log history.
