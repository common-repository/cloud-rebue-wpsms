                    ...
                    <?php
                        ...
                        <div class="card2 postbox" style="padding: 50px;">
                            ...
                            <div class="card-body" style="">
                                ...
                                <h3>New Order & Payment Notifications Settings For Admin</h3>
                                <p>Enter the contents of the SMS message to be sent to the <strong>admin phone number</strong>. <br />
                                    <i>(or leave the field empty to disable the notification type)</i>.
                                </p>
                                <div class='form-group'>
                                    <label style='display:block;font-weight:bold;'>Admin Phone Number</label>
                                    <input type="text" name='crsms_admin_phone' style='width:90%;max-width:100%; margin-top:20px; margin-bottom:10px;' value="<?php echo get_option("crsms_admin_phone"); ?>" />
                                </div>
                                <div class='form-group'>
                                    <label style='display:block;font-weight:bold;'>New Order SMS Content</label>
                                    <textarea name='crsms_notif_wc-new_admin' style='width:90%;max-width:100%; margin-top:20px; margin-bottom:10px;'><?php echo get_option("crsms_notif_wc-new_admin"); ?></textarea>
                                </div>
                                <div class='form-group'>
                                    <label style='display:block;font-weight:bold;'>Payment Completed SMS Content</label>
                                    <textarea name='crsms_notif_wc-payment_admin' style='width:90%;max-width:100%; margin-top:20px; margin-bottom:10px;'><?php echo get_option("crsms_notif_wc-payment_admin"); ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="card2 postbox" style="padding: 50px;">
                            <h3>Order Status Change Notifications Settings</h3>
                            <div class="card-body" style="">
                                <p>Enter the contents of the SMS message to be sent to the billing-phone number. <br />
                                    <i>(or leave the field empty to disable the notification type)</i>.
                                </p>
