            ...
            <div class='custom-nav-pane active' id='baseTab'>
                ...
                <table class="form-table">
                    ...
                    <tr valign="top">
                        ...
                        <td><input type="text" name="crsms_token" value="<?php echo esc_attr(get_option('crsms_token')); ?>" size="100" />
                            <p>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <label>
                                <input type="text" maxlength="11" name="crsms_default_sender" value="<?php echo esc_attr(get_option('crsms_default_sender')); ?>">
                            </label>
